      ...
      children: <Widget>[
          ...
          child: Container(
              ...
              child: ListTile(
                  ...
                  title: Text("Alert notification" ,style: TextStyle(color:Color(0xFFC2185B)),),
                  subtitle: Text("Maintenance and repair service could be a broad term\n. A maintenance service agreement is then deemed to differ \naccording to an array of specifics depending on anyone who asks for it." ,style: TextStyle(color:Colors.black) ),
     ...
     Padding(
          ...
          child: Container(
              ...
              child: ListTile(
                  ...
                  title: Text("Chrismiss Alert" ,style: TextStyle(color:Color(0xFFC2185B)),),
                  subtitle: Text("Maintenance and repair service could be a broad term\n. A maintenance service agreement is then deemed to differ \naccording to an array of specifics depending on anyone who asks for it." ,style: TextStyle(color:Colors.black) ),
